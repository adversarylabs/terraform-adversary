...
const ruleCases = [{"key":"public-ingress","id":"terraform.public-ingress"},{"key":"mutable-module","id":"terraform.mutable-module"},{"key":"sensitive-output","id":"terraform.sensitive-output"}];
